const Banner = () => {
   return (
      <div className="bg-bgImgGradient lg:h-screen bg-cover bg-center px-4">
         <div className="md:w-4/5 lg:w-3/5 flex flex-col justify-center h-full gap-7 py-6">
            ...
            <div className="flex items-center">
               <button className="btn btn-success mr-5">Add Job</button>
               <button className="btn btn-success btn-outline">See Job</button>
            </div>
         </div>
      </div>
   );
